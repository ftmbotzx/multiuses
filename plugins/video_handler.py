...
async def show_trim_options(client: Client, callback_query: CallbackQuery, video_message: Message):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("✂️ ᴄᴜsᴛᴏᴍ", callback_data=f"custom_trim_{video_message.id}")
        ],
        [
...
@Client.on_callback_query(filters.regex(r"^custom_trim_"))
async def custom_trim_s(client: Client, callback_query: CallbackQuery):
