...
@Client.on_message(filters.text & filters.private & ~filters.command(["start", "help", "cancel", "credits", "referral", "premium", "sample", "admin", "myplan", "redeem", "refer", "refstats", "earncredits", "setthumbnail", "deletethumbnail", "showthumbnail", "broadcast", "ban", "unban", "addpremium", "createcode", "status", "logs", "dbbackup", "restart", "searchuser", "managebot", "admintest"]))
